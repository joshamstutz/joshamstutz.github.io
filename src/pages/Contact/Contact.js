            ...
            <div className="contentl">
              ...
              <div className="social-links">
                <div className="social-item">
                  ...
                  <a href="https://github.com/joshamstutz" target="_blank" rel="noopener noreferrer"
                     className="username">joshamstutz</a>
                </div>
                <div className="social-item">
                  <img src={linkedinLogo} alt="LinkedIn" className="social-logo"/>
                  <a href="https://linkedin.com/in/josh-amstutz" target="_blank" rel="noopener noreferrer"
                     className="username">in/josh-amstutz</a>
                </div>
                <div className="social-item">
            ...
            <div className="contentr">
              ...
              <div className="social-links">
                <div className="social-item">
                  ...
                  <a href="https://instagram.com/josh.amstutz" target="_blank" rel="noopener noreferrer"
                     className="username">josh.amstutz</a>
                </div>
                <div className="social-item">
                  <img src={xLogo} alt="X" className="social-logo"/>
                  <a href="https://x.com/josh_amstutz" target="_blank" rel="noopener noreferrer"
                     className="username">josh_amstutz</a>
                </div>
                <div className="social-item">
                  <img src={discordLogo} alt="Discord" className="social-logo"/>
                  <a href="https://discord.com/users/joshamstutz" target="_blank" rel="noopener noreferrer"
                     className="username">joshamstutz</a>
                </div>
              </div>
            </div>
